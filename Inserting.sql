...
VALUES
    (12345678901, 2, 1, 4, 1, 1),
    (23456789012, 2, 3, 1, 4, 1),
    (34567890123, 2, 2, 2, 1, 3),
    (45678901234, 2, 4, 1, 2, 3),

	(12345678901, 7, 1, 3, 3, 0),
    (23456789012, 7, 4, 1, 1, 4),
    (34567890123, 7, 2, 3, 2, 1),
    (45678901234, 7, 3, 1, 2, 3),

	(12345678902, 1, 1, 3, 3, 0),
    (23456789013, 1, 4, 1, 1, 4),
    (34567890124, 1, 2, 3, 2, 1),
    (45678901235, 1, 3, 1, 2, 3);
...
--Statistiche per le 3 stagioni
INSERT INTO Statistica (Codice_Stagione, CodiceFiscale_Calciatore, PartiteDisputate, Goal, Assist)
VALUES 
    (2, 'CNTNCR80T03F567F', 6, 0, 1),
    (2, 'CRRMRO98E01F145H', 6, 0, 2),
    (2, 'FRRMTN91C18F901V', 6, 0, 0),
    (2, 'GNCLUC89T05F123S', 6, 0, 1),
    (2, 'LMNTLL91M09F346G', 6, 0, 0),
    (2, 'MRCNTN88H02F444D', 6, 0, 2),
    (2, 'PLTDSR92P08F333B', 6, 0, 1),
    (2, 'PNCNTN92H02F548K', 6, 0, 0),
    (2, 'RSSMRA93L07F230L', 6, 0, 1),
    (2, 'SMLNSN88H25F123L', 6, 0, 0),
    (2, 'VRDLLI94L12F547R', 6, 0, 2),
    (2, 'BNCMRA99L28F432V', 6, 0, 1),
    (2, 'BRCNCR87C04F839L', 6, 0, 2),
    (2, 'CMBCMR81H25F312M', 6, 0, 1),
    (2, 'CNTLSM82T01F367Q', 6, 0, 1),
    (2, 'DMRLCN91C02F567V', 6, 0, 1),
    (2, 'GRGSMR94H03F234T', 6, 0, 2),
    (2, 'PLRRSS92P05F145H', 6, 0, 2),
    (2, 'PLRSPR94M15L234L', 6, 0, 1),
    (2, 'SMNDRM89T03F312K', 6, 0, 0),
    (2, 'SRTLSM80L06F321T', 6, 0, 0),
    (2, 'VRDDVD96F12F543T', 6, 0, 1),
    (2, 'BRCGNN92C08H654S', 6, 0, 0),
    (2, 'CNTLCU87D11G098D', 6, 0, 2),
    (2, 'DNNRSM93H06H222B', 6, 0, 2),
    (2, 'FRRMRA89H20G321R', 6, 0, 0),
    (2, 'GNLCHR94M25B321Q', 6, 0, 0),
    (2, 'LMNLNE96M12A654K', 6, 0, 0),
    (2, 'RMNLSX92C22A765W', 6, 0, 2),
    (2, 'RZZFBA93M03A432G', 6, 0, 0),
    (2, 'SMNRMS95M09A432R', 6, 0, 1),
    (2, 'SNVTLN90B05H567S', 6, 0, 1),
    (2, 'VNRMTT94L09L098L', 6, 0, 0),
    (2, 'BRCGNN93M07A987H', 6, 0, 1),
    (2, 'BRCGNN94F07D765F', 6, 0, 0),
    (2, 'CMBMRA84C15C090S', 6, 0, 1),
    (2, 'CNTLSS91M05G876R', 6, 0, 1),
    (2, 'DNNRSM92H06C432B', 6, 0, 0),
    (2, 'GRGNTN89H08B321V', 6, 0, 2),
    (2, 'PLRSPR91M21L222S', 6, 0, 2),
    (2, 'PLRSPR94D21F543R', 6, 0, 1),
    (2, 'SMNRMS94M09B333P', 6, 0, 0),
    (2, 'SRTVTR89D02E222R', 6, 0, 2),
    (2, 'VNRMTT92L22G654J', 6, 0, 1),

	(7, 'CNTNCR80T03F567F', 6, 0, 0),
    (7, 'CRRMRO98E01F145H', 6, 0, 1),
    (7, 'FRRMTN91C18F901V', 6, 0, 2),
    (7, 'GNCLUC89T05F123S', 6, 0, 0),
    (7, 'LMNTLL91M09F346G', 6, 0, 1),
    (7, 'MRCNTN88H02F444D', 6, 0, 2),
    (7, 'PLTDSR92P08F333B', 6, 0, 0),
    (7, 'PNCNTN92H02F548K', 6, 7, 1),
    (7, 'RSSMRA93L07F230L', 6, 0, 2),
    (7, 'SMLNSN88H25F123L', 6, 0, 0),
    (7, 'VRDLLI94L12F547R', 6, 3, 1),
    (7, 'BNCMRA99L28F432V', 6, 0, 2),
    (7, 'BRCNCR87C04F839L', 6, 0, 0),
    (7, 'CMBCMR81H25F312M', 6, 0, 1),
    (7, 'CNTLSM82T01F367Q', 6, 2, 2),
    (7, 'DMRLCN91C02F567V', 6, 0, 0),
    (7, 'GRGSMR94H03F234T', 6, 0, 1),
    (7, 'PLRRSS92P05F145H', 6, 6, 2),
    (7, 'PLRSPR94M15L234L', 6, 0, 0),
    (7, 'SMNDRM89T03F312K', 6, 0, 1),
    (7, 'SRTLSM80L06F321T', 6, 0, 2),
    (7, 'VRDDVD96F12F543T', 6, 0, 0),
    (7, 'BRCGNN92C08H654S', 6, 0, 1),
    (7, 'CNTLCU87D11G098D', 6, 4, 2),
    (7, 'DNNRSM93H06H222B', 6, 0, 0),
    (7, 'FRRMRA89H20G321R', 6, 0, 1),
    (7, 'GNLCHR94M25B321Q', 6, 0, 2),
    (7, 'LMNLNE96M12A654K', 6, 0, 0),
    (7, 'RMNLSX92C22A765W', 6, 5, 1),
    (7, 'RZZFBA93M03A432G', 6, 0, 2),
    (7, 'SMNRMS95M09A432R', 6, 0, 0),
    (7, 'SNVTLN90B05H567S', 6, 0, 1),
    (7, 'VNRMTT94L09L098L', 6, 0, 2),
    (7, 'BRCGNN93M07A987H', 6, 0, 0),
    (7, 'BRCGNN94F07D765F', 6, 3, 1),
    (7, 'CMBMRA84C15C090S', 6, 0, 2),
    (7, 'CNTLSS91M05G876R', 6, 3, 0),
    (7, 'DNNRSM92H06C432B', 6, 0, 1),
    (7, 'GRGNTN89H08B321V', 6, 0, 2),
    (7, 'PLRSPR91M21L222S', 6, 0, 0),
    (7, 'PLRSPR94D21F543R', 6, 0, 1),
    (7, 'SMNRMS94M09B333P', 6, 0, 2),
    (7, 'SRTVTR89D02E222R', 6, 0, 0),
    (7, 'VNRMTT92L22G654J', 6, 0, 1),

	(1, 'CNTNCR80T03F567F', 6, 0, 0),
    (1, 'CRRMRO98E01F145H', 6, 0, 1),
    (1, 'FRRMTN91C18F901V', 6, 0, 2),
    (1, 'GNCLUC89T05F123S', 6, 0, 0),
    (1, 'LMNTLL91M09F346G', 6, 0, 1),
    (1, 'MRCNTN88H02F444D', 6, 0, 2),
    (1, 'PLTDSR92P08F333B', 6, 0, 0),
    (1, 'PNCNTN92H02F548K', 6, 0, 1),
    (1, 'RSSMRA93L07F230L', 6, 0, 2),
    (1, 'SMLNSN88H25F123L', 6, 0, 0),
    (1, 'VRDLLI94L12F547R', 6, 0, 1),
    (1, 'BNCMRA99L28F432V', 6, 0, 2),
    (1, 'BRCNCR87C04F839L', 6, 0, 0),
    (1, 'CMBCMR81H25F312M', 6, 0, 1),
    (1, 'CNTLSM82T01F367Q', 6, 0, 2),
    (1, 'DMRLCN91C02F567V', 6, 0, 0),
    (1, 'GRGSMR94H03F234T', 6, 0, 1),
    (1, 'PLRRSS92P05F145H', 6, 0, 2),
    (1, 'PLRSPR94M15L234L', 6, 0, 0),
    (1, 'SMNDRM89T03F312K', 6, 0, 1),
    (1, 'SRTLSM80L06F321T', 6, 0, 2),
    (1, 'VRDDVD96F12F543T', 6, 0, 0),
    (1, 'BRCGNN92C08H654S', 6, 0, 1),
    (1, 'CNTLCU87D11G098D', 6, 0, 2),
    (1, 'DNNRSM93H06H222B', 6, 0, 0),
    (1, 'FRRMRA89H20G321R', 6, 0, 1),
    (1, 'GNLCHR94M25B321Q', 6, 0, 2),
    (1, 'LMNLNE96M12A654K', 6, 0, 0),
    (1, 'RMNLSX92C22A765W', 6, 0, 1),
    (1, 'RZZFBA93M03A432G', 6, 0, 2),
    (1, 'SMNRMS95M09A432R', 6, 0, 0),
    (1, 'SNVTLN90B05H567S', 6, 0, 1),
    (1, 'VNRMTT94L09L098L', 6, 0, 2),
    (1, 'BRCGNN93M07A987H', 6, 0, 0),
    (1, 'BRCGNN94F07D765F', 6, 0, 1),
    (1, 'CMBMRA84C15C090S', 6, 0, 2),
    (1, 'CNTLSS91M05G876R', 6, 0, 0),
    (1, 'DNNRSM92H06C432B', 6, 0, 1),
    (1, 'GRGNTN89H08B321V', 6, 0, 2),
    (1, 'PLRSPR91M21L222S', 6, 0, 0),
    (1, 'PLRSPR94D21F543R', 6, 0, 1),
    (1, 'SMNRMS94M09B333P', 6, 0, 2),
    (1, 'SRTVTR89D02E222R', 6, 0, 0),
    (1, 'VNRMTT92L22G654J', 6, 0, 1);

insert into Marcatori (Codice_Partita, CodiceFiscale_Calciatore, NumeroGoal)
values
	--Marcatori juve
	(13,'PNCNTN92H02F548K',3),
	(15,'PNCNTN92H02F548K',1),
	(17,'PNCNTN92H02F548K',1),
	(19,'PNCNTN92H02F548K',2),
	(22,'VRDLLI94L12F547R',1),
	(23,'VRDLLI94L12F547R',2),
	--Marcatori milan
	(13,'PLRRSS92P05F145H',2),
	(19,'PLRRSS92P05F145H',2),
	(21,'PLRRSS92P05F145H',2),
	(21,'CNTLSM82T01F367Q',1),
	(24,'CNTLSM82T01F367Q',2),
	--Marcatori inter
	(14,'RMNLSX92C22A765W',2),
	(16,'RMNLSX92C22A765W',2),
	(17,'RMNLSX92C22A765W',1),
	(20,'CNTLCU87D11G098D',1),
	(24,'CNTLCU87D11G098D',3),
	--Marcatori roma
	(14,'BRCGNN94F07D765F',1),
	(15,'BRCGNN94F07D765F',1),
	(18,'BRCGNN94F07D765F',1),
	(18,'CNTLSS91M05G876R',1),
	(20,'BRCGNN94F07D765F',1),
	(21,'BRCGNN94F07D765F',1);